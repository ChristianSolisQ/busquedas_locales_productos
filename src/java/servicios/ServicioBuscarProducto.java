 ...
 * @author Usuario
 */
@WebServlet(name = "ServicioBuscarProducto", urlPatterns = {"/ServicioBuscarProducto"})
public class ServicioBuscarProducto extends HttpServlet {
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        try (PrintWriter out = response.getWriter()) {
            out.println(listarVentasProductotoJSON());
        }
    }

    public String listarVentasProductotoJSON() {
